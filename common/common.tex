...
% \usepackage[]{geometry}
\usepackage[a4paper, total={6.75in, 8.75in}]{geometry}
...
\usepackage{minted}
\usepackage{url} % package for url display in references
\usepackage{pdfpages} % package for appending a .pdf
