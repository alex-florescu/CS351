...
proc create_root_design { parentCell } {
  ...
  set IIC_Interface [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:iic_rtl:1.0 IIC_Interface ]
  ...
  set led5_rgb [ create_bd_port -dir O -from 2 -to 0 led5_rgb ]
  set led6_rgb [ create_bd_port -dir O -from 2 -to 0 led6_rgb ]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_IIC_1 [get_bd_intf_ports IIC_Interface] [get_bd_intf_pins processing_system7_0/IIC_1]

  # Create port connections
  connect_bd_net -net ac_recdat_1 [get_bd_ports ac_recdat] [get_bd_pins top_0/ac_recdat]
  connect_bd_net -net btn_1 [get_bd_ports btn] [get_bd_pins top_0/btn]
  ...
  connect_bd_net -net rst_1 [get_bd_ports rst] [get_bd_pins top_0/rst]
  connect_bd_net -net sw_1 [get_bd_ports sw] [get_bd_pins top_0/sw]
  connect_bd_net -net sysclk_1 [get_bd_ports sysclk] [get_bd_pins top_0/sysclk]
  connect_bd_net -net top_0_ac_bclk [get_bd_ports ac_bclk] [get_bd_pins top_0/ac_bclk]
  connect_bd_net -net top_0_ac_mclk [get_bd_ports ac_mclk] [get_bd_pins top_0/ac_mclk]
  connect_bd_net -net top_0_ac_muten [get_bd_ports ac_muten] [get_bd_pins top_0/ac_muten]
  connect_bd_net -net top_0_ac_pbdat [get_bd_ports ac_pbdat] [get_bd_pins top_0/ac_pbdat]
  connect_bd_net -net top_0_ac_pblrc [get_bd_ports ac_pblrc] [get_bd_pins top_0/ac_pblrc]
  connect_bd_net -net top_0_ac_reclrc [get_bd_ports ac_reclrc] [get_bd_pins top_0/ac_reclrc]
  connect_bd_net -net top_0_led [get_bd_ports led] [get_bd_pins top_0/led]
  connect_bd_net -net top_0_led5_rgb [get_bd_ports led5_rgb] [get_bd_pins top_0/led5_rgb]
  connect_bd_net -net top_0_led6_rgb [get_bd_ports led6_rgb] [get_bd_pins top_0/led6_rgb]
