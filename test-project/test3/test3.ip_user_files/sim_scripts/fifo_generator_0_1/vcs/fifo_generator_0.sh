...
design_libs=(xilinx_vip xpm fifo_generator_v13_2_9 xil_defaultlib)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work fifo_generator_v13_2_9 $vlogan_opts +v2k +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
