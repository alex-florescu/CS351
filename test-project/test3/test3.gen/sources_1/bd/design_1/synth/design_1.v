...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=2,numReposBlks=2,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=3,da_ps7_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  assign ac_pbdat = top_0_ac_pbdat;
  assign ac_pblrc = top_0_ac_pblrc;
  ...
  design_1_top_0_0 top_0
       (.ac_bclk(top_0_ac_bclk),
        .ac_mclk(top_0_ac_mclk),
        .ac_muten(top_0_ac_muten),
        .ac_pbdat(top_0_ac_pbdat),
